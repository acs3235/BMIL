...
%
%    C:\Users\acs3235\Documents\BMIL\BMIL\photonics_data.txt
%
% To extend the code to different selected data or a different text file,
% generate a function instead of a script.

% Auto-generated by MATLAB on 2017/01/19 17:05:24

%% Initialize variables.
filename = 'C:\Users\acs3235\Documents\BMIL\BMIL\photonics_data.txt';
delimiter = '\t';
...
for i = 1:2:9
    semilogy(cell2mat(raw(:, i)),cell2mat(raw(:, i+1)))
    hold all;
end

axis([-inf, inf, 10^(-4), 10^3])
